...
from lib.installer.cmd.copy import exec as exec_copy
from lib.installer.cmd.dosbox import exec as exec_dosbox
from lib.installer.cmd.extract import exec as exec_extract
from lib.installer.cmd.file import exec as exec_file
