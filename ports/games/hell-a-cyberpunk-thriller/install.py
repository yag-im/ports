...
APP_EXEC_PATH = APP_DIR / "HELL.COM"
INSTALLER_EXEC_PATH = FIRST_CD_DRIVE_DIR / "HELLINST.EXE"
...
class Main(Installer):
    def __init__(self, app_desc: AppDesc):
        ...
        if app_desc.distro.format == "1CD":
            ...
            dbox = DosBoxDos(dst_folder, app_desc, DosBoxDosConf(mod=DosBoxMod.X, cycles="max"))
