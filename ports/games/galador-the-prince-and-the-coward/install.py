    ...
    def __init__(self, app_desc: AppDesc):
        ...
        if app_desc.distro.format == "1CD":
            ...
            if app_desc.lang == "pl":
                ...
                copy(src_folder / app_exec, dst_folder / FIRST_CD_DRIVE_LETTER / "DATA")
                w.gen_run_script(app_exec=app_exec, work_dir=FIRST_CD_DRIVE / "DATA")
                ...
                w.run(FIRST_CD_DRIVE / "autorun.exe", virtual_desktop=VirtualDesktopResolution.RES_640_480)
                unmount_cds(w, dst_folder, FIRST_CD_DRIVE_LETTER, len(app_desc.distro.files))
