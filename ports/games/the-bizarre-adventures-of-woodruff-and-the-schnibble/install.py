    ...
    def __init__(self, app_desc: AppDesc):
        ...
        if app_desc.distro.format == "1CD":
            ...
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                unpack_disc_image(src_path, tmp_dir_path, creates=tmp_dir_path / "WOODRUFF.ITK")
                copy(tmp_dir_path / "WOODRUFF.ITK", dst_app_path)
                copy(tmp_dir_path / "INTRO.STK", dst_app_path)
            ScummVm(dst_path, "gob:woodruff", lang=app_desc.lang).gen_run_script()
        else:
