...
from lib.dosbox.const import FIRST_CD_DRIVE_DIR
...
from lib.wine.const import FIRST_CD_LETTER
...
class Main(Installer):
    def __init__(self, app_desc: AppDesc):
        ...
        if app_desc.distro.format == "1CD":
            ...
            dbox.run(FIRST_CD_DRIVE_DIR / "Support" / "DX7Aeng.exe")
            dbox.run(FIRST_CD_DRIVE_DIR / "Support" / "iv5setup.exe")
